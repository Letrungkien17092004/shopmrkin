                ...
                <div className="row">
                    <div className="col c-10 m-10 l-6 c-o-1 l-o-3 ">
                        <section className="width-full border-radius-8px padding-bot-12px box-shadow-1">
                            <h1 className="padding-top-bot-12px text-align-center">Đăng ký tài khoản</h1>
                            <form className="flex flex-column row-gap-10px justify-content-center padding-left-right-24px" action="">
                                ...
                                <div className="padding-left-8px width-full text-error">
                                    **
                                    <span className="font-size-1rem">Tài khoản đã tồn tại</span>
                                </div>
                                {/* input */}
                                <input autoComplete="on" name="username" className="no-border font-size-1d2rem  border-radius-8px border-bot-style-1 padding-8px width-full height-3rem" type="text" placeholder="Tên người dùng" />
                                ...
                                >
                                    <span className="font-size-1d4rem">Đăng ký</span>
                                </button>
                            </form>
